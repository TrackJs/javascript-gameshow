...
(async () => {
  ...
  document.querySelector("#select-question-form").addEventListener("submit", (evt) => {
    ...
    const questionRef = firebase.database().ref(`lastStandingQuestions/${questionId}`)
  ...
  async function startup() {
    ...
    questionRef = firebase.database().ref('lastStandingQuestions');
